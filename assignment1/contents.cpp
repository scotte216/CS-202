...
//default constructor
node_cont::node_cont():item(),next(NULL),previous(NULL)
{
}


//constructor given an item
node_cont::node_cont(attributes & item):item(item),previous(NULL),next(NULL)
{
}
...
//should be directed
node_cont::node_cont(attributes & item, node_cont * & previous):item(item),previous(previous),next(NULL)
{
}
